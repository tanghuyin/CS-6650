...
public class RedisClient {
  ...
  public void increaseVerticalForSkierOnDay(String skierID, String dayID, int value) {
    p.incrBy("s:" + skierID + ";d:" + dayID + "_v", value);
  }
  ...
  public void addSkierToResortByDay(String resortID, String dayID, String skierID) {
    p.sadd("r:" + resortID + ";d:" + dayID, skierID);
  }
